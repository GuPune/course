            ...
            <div class="breadcrumb__content__wraper" data-aos="fade-up">
              <div class="breadcrumb__title">
                <span style="font-size: 24px; font-weight: bold"
                  >{{ store.course_curent.course_code }} -
                  {{
                    locale == "la"
                      ? store.course_curent.course_name_lo
                      : store.course_curent.course_name_eng
                  }}
                  / {{ $t("course_subject") }}:
                  {{
                    locale == "la"
                      ? store.curent_lesson.cg_name_lo
                      : store.curent_lesson.cg_name_eng
                  }}</span
                >
              </div>
            </div>
          ...
          <div class="col-xl-12 col-lg-12">
            ...
            <div class="blog__details__content__wraper">
                ...
                >
                  ...
                  >
                    <div
                      ...
                      id="accordionExample"
                      v-if="store.curent_lesson.cs_name_lo"
                    >
                        ...
                        <h2 class="accordion-header" id="headingOne">
                          ...
                          >
                            <span
                              ...
                              "
                              v-if="
                                store.curent_lesson.cs_name_lo
                                  .trim()
                                  .endsWith('?')
                              "
                              >{{ $t("question") }} :
              ...
              <div
                class="tab-content tab__content__wrapper"
                id="myTabContent"
                v-if="store.curent_lesson.cs_description"
              >
                <div
                  class="tab-pane fade active show"
                  id="projects__two"
