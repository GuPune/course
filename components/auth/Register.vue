            ...
            v$.email.$errors[0].$message
                                              ...
                                              <div class="col-xl-12">
                                                  <div class="login__form">
                                                      ...
                                                      <input class="common__login__input" type="text" placeholder="Tel" v-model="formDataregister.tel"
                                                      :class="{
            ...
            v$.tel.$errors[0].$message
                                              ...
                                              <div class="col-xl-6">
                                                  <div class="login__form">
                                                      ...
                                                      <input class="common__login__input" type="password" placeholder="Password"  v-model="formDataregister.password"
                                                      :class="{
                'border-red-500 focus:border-red-500': v$.email.$error,
                'border-[#42d392] ': !v$.email.$invalid,
              }"
            ...
            v$.password.$errors[0].$message
                                              ...
                                              <div class="col-xl-6">
                                                  <div class="login__form">
                                                      ...
                                                      <input class="common__login__input" type="password" placeholder="Re-Enter Password"   v-model="formDataregister.confirmPassword"
                                                      :class="{
                'border-red-500 focus:border-red-500': v$.email.$error,
                'border-[#42d392] ': !v$.email.$invalid,
              }"
            ...
            v$.confirmPassword.$errors[0].$message
                                          ...
                                          <div class="login__form d-flex justify-content-between flex-wrap gap-2">
                                              <div class="form__check">
                                                  <input id="accept_pp" type="checkbox"   v-model="formDataregister.accp"> <label for="accept_pp">Accept the Terms and Privacy Policy</label>
                                          ...
                                          <span class="text-xs text-red-500" style="color:red" v-if="v$.accp.$error">{{ v$.accp.$errors[0].$message }}</span>
