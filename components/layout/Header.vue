              ...
              <ul class="mobile-menu">
                ...
                <li class="menu-item-has-children">
                  ...
                  <ul class="dropdown">
                    ...
                    <li>
                      <a href="course-details-dark.html">Details (Dark)</a>
                    </li>
                    <li><a href="course-details-2.html">Details 2</a></li>
                    <li>
                      <a href="course-details-2-dark.html">Details 2 (Dark)</a>
                    </li>
                    <li><a href="course-details-3.html">Details 3</a></li>
                    <li>
                      <a href="course-details-3-dark.html">Details 3 (Dark)</a>
                    </li>
                  </ul>
                </li>

                <li class="menu-item-has-children">
                  <a href="instructor.html">Pages</a>
                  <ul class="dropdown">
                    ...
                    <li>
                      <a href="instructor-details-dark.html">Details (Dark)</a>
                    </li>
                    <li><a href="event-details.html">Event-Details</a></li>
                    <li>
                      <a href="event-details-dark.html">Details (Dark)</a>
                    </li>
                ...
                <li>
                  <a class="menu-item-has-children" href="contact.html"
                    >Contact</a
                  >
                </li>
              </ul>
        ...
        <div class="mobile-curr-lang-wrap">
          <div class="single-mobile-curr-lang">
            <a class="mobile-language-active" href="#"
              >Language <i class="icofont-thin-down"></i
            ></a>
          ...
          <div class="single-mobile-curr-lang">
            <a class="mobile-account-active" href="#"
              >My Account <i class="icofont-thin-down"></i
            ></a>
